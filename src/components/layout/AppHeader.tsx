...
export function AppHeader() {
  ...
  // If we are still loading the profile or there are no plants yet, just show a plain header
  if (isLoading || !profile) {
    return (
      <header className="sticky top-0 z-50 flex h-10 items-center justify-between border-b bg-background px-4">
